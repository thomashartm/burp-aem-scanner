...
import legacy.actions.http.GetRequest;
import legacy.actions.http.HttpMethod;
import legacy.actions.http.ResponseHolder;
import legacy.payload.DefaultCredential;

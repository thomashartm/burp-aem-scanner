...
import legacy.LegacyBurpExtender;
import legacy.BurpHelperDto;
import burp.IBurpExtenderCallbacks;
import burp.IExtensionHelpers;
import legacy.actions.SecurityCheckExecutorService;
import legacy.actions.accesscontrol.DefaultLoginWithLoginPagePossible;
import legacy.actions.accesscontrol.WriteAccessPossible;
import legacy.actions.crx.CrxExposedDetector;
import legacy.actions.dispatcher.*;
import legacy.actions.misconfiguration.AuditServletDetector;
import legacy.actions.misconfiguration.DebugFilterDetector;
import legacy.actions.misconfiguration.WcmSuggestionServletDetector;
import legacy.actions.xss.FlippingTypeWithChildrenlistSelector;
import legacy.actions.xss.XSSinSWFDetector;
